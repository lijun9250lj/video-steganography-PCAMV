...
enum intra_chroma_pred_e
{
    ...
    I_PRED_CHROMA_DC_LEFT = 4, // 从左边的DC进行预测
    I_PRED_CHROMA_DC_TOP  = 5, // 从上面的DC预测
    I_PRED_CHROMA_DC_128  = 6  // 以128默认值进行DC 预测
};
/*调整一下预测模式的数值，其实预测只有4中方式DC、V、H、P*/
...
{
    I_PRED_4x4_V  = 0, // vertical
    I_PRED_4x4_H  = 1, // horizontal
    I_PRED_4x4_DC = 2, // DC
    I_PRED_4x4_DDL= 3, // diagonal down-left
    I_PRED_4x4_DDR= 4, // diagonal down-right
    I_PRED_4x4_VR = 5, // vertical-right
    I_PRED_4x4_HD = 6, // horizontal-down
    I_PRED_4x4_VL = 7, // vertical-left
    I_PRED_4x4_HU = 8, // horizontal-up
