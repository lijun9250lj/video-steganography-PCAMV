...
static void sub4x4_dct( int16_t dct[4][4], uint8_t *pix1, uint8_t *pix2 )//4*4最小单位的求残差并dct变换，    //pix1一般为编码帧（enc）    //pix2一般为重建帧（dec）
{
    int16_t d[4][4];
    int16_t tmp[4][4];
    int i;
